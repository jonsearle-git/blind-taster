...
function scoreAnswer(question, playerAnswer, correctAnswer) {
  switch (question.type) {
    ...
    case "tags" /* Tags */: {
      ...
      const matches = correctAnswer.selectedTagIds.filter(
        (id) => playerAnswer.selectedTagIds.includes(id)
      ).length;
...
// .wrangler/tmp/bundle-WwagrL/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-WwagrL/middleware-loader.entry.ts
